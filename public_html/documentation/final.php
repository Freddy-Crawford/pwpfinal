		...
		<nav class="navbar fixed-top navbar-default navbar-expand-md navbar-dark bg-dark" id="top-of-page">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a href="https://github.com/Freddy-Crawford" target="_blank" class="nav-link"><i class="fa fa-github fa-2x" aria-hidden="true"></i></a>
					</li>
					<li class="nav-item">
		...
		<section class="p-5 solid mt-0" id="About Me">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-12 col-md-4 col-lg-6"><img class="img-fluid" src="fcharles.jpg" alt= "pic of me " id="about-image"></div>
				</div>
			</div>
		</section>
		<!-- parallax section 2 -->
		<div class="parallax-content parallax-content2">
			<div class="parallax">
				<div class="jumbotron bg-transparent text-left">
					<h3>“For a long time it puzzled me how something so expensive, so leading edge, could be so useless. And then it occurred to me that a computer is a stupid machine with the ability to do incredibly smart things, while computer programmers are smart people with the ability to do incredibly stupid things. They are, in short, a perfect match.”
						- Bill Bryson</h3>
				</div>
			</div>
		</div>
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-12 m-3">
									<img src="json.png" class="col-md-2 col-lg-2" alt="json logo">
										<img src="mysql.png" class="col-md-2 col-lg-2" alt="mysql logo">
									<img src="../bootstrap2.png" class="col-md-2 col-lg-2" alt="bootstraplogo">
									<img src="git.png" class="col-md-2 col-lg-2" alt="git logo">
								</div>
							</div>
						</div>
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-12 m-3">
									<img src="jquery.png" class="col-md-2" alt="jquery">
										<img src="angular-logo.png" class="col-md-2" alt="angular logo">
									<img src="../html-logo-small.png" class="col-md-2" alt="html logo">
									<img src="../css3.png" class="col-md-2" alt="css logo">
									<img src="stackoverflow.png" class="col-md-2 col-lg-2" alt="stack logo">
								</div>
							</div>
						</div>
					</div>
		...
		<div class="parallax-content parallax-content3">
			<div class="parallax">
				<div class="jumbotron bg-transparent text-right">
					<h3>“Creativity is more than just being different.
						Anybody can plan weird; that’s easy. What’s hard is to be as simple as Bach. Making the simple,
						awesomely simple, that’s creativity” – Charles Mingus</h3>
				</div>
			</div>
		</div>
		...
		<div class="parallax-content parallax-content4">
			<div class="parallax">
				<div class="jumbotron bg-transparent text-center">
						<h1>Together We Can Build Great Things</h1>
					<h2>Lets Do Something Great</h2>
				</div>
			</div>
		</div>
