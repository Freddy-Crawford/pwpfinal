...
<html>
	...
	<body>
		...
		<section class="parallax-content">
				<div class="parallax">
					...
					<h4>Web Designer/Software Developer</h4>
						<h3>I Want To Use Technology To Change The World</h3>
				</div>
			</div>
		</section>
		...
		<section class="p-5 solid mt-0" id="About Me">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-12 col-md-4 col-lg-6"><img class="image-fluid" src="mypic.jpg" height="325" alt ="pic of me " id="mypic"></div>
					</div>
			</div>
		</section>
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-12 m-3">
									...
									<img src="php.png" class="col-md-2 col-lg-2" alt="php logo">
								</div>
							</div>
						</div>
								<div class="container-fluid">
		...
		<div class="parallax-content parallax-content3">
			<div class="parallax">
				<div class="jumbotron bg-transparent text-center">
					<h1>“Creativity is more than just being different.
						Anybody can plan weird; that’s easy. What’s hard is to be as simple as Bach. Making the simple,
						awesomely simple, that’s creativity” – Charles Mingus</h1>
				</div>
			</div>
		</div>
